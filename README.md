...
Україномовний абсурдний Telegram-бот для групових чатів з підтримкою великого контекстGEMINI_API_KEY=your-gemini-api-key
# Рекомендована модель: gemini-2.5-flash (безкоштовна)
GEMINI_MODEL=gemini-2.5-flash
BOT_PERSONA_NAME=Гряг
BOT_PERSONA_DESC=Зачекайте, я реальний?!а інтеграцією з Gemini Flash 2.5.

## 🎭 Особливості
- **Абсурдна персона**: Гряг — непередбачуваний дух чату з власним життям
...
- **Анти-спам**: розумні ліміти відповідей, мінімальні паузи між спонтанними повідомленнями
- **Автономність**: може спонтанно писати, але не спамить
...
BOT_PERSONA_NAME=Глек
BOT_PERSONA_DESC=Зачекайте, я реальний?!
