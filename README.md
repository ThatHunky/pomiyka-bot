...
## 🎭 Особливості
- **Дружелюбна персона**: Гряг — кмітливий помічник з легким гумором
- **Покращена Gemini інтеграція**: повна підтримка system instructions, safety settings, thinking mode, structured output
- **Розумна обробка контексту**: автоматичне стиснення, адаптивні режими (normal, minimal, guidance, humor)
- **Динамічна поведінка**: підлаштовується під настрій чату з аналізом ситуації
